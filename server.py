...
myRtr = Retrievor.UndirectedG\
    ('webapp630/addNodeEdgeDegree_R+rn+GMHM_undirected_alpha0.65_nodeD1.0_total_v3_csvneo4j', 'total_v3_csvneo4j',
     'userdata')
...
with open('../webapp630/data2021/wiki_word2id.json', encoding='utf8')as fp:
...
def generator(info):
    ...
    print("generator: distance: ", distance)
    print("generator: query_type: ", query_type)
    ...
    print("generator: explorenodes: ", explorenodes)
    print("generator: explorepaths: ", explorepaths)
    print("generator: position: ", position)
